...
def are_alerts_equal(alert1, alert2):
    ...
    print(str(alert1["coordinates"])[1:-1] == str(alert2[7])[1:-1])
    print(str(alert1["coordinates"])[1:-1], str(alert2[7])[1:-1])
    print(str(alert1["risk"]) == str(alert2[3]))
    print(str(alert1["certainty"]) == str(alert2[4]))
    print(str(alert1["start"]) == str(alert2[5]))
    print(str(alert1["end"]) == str(alert2[6]))

    print()
    if(str(alert1["headline"]) == str(alert2[1]) and str(alert1["location"]) == str(alert2[2]) and str(alert1["coordinates"])[1:-1] == str(alert2[7])[1:-1] and str(alert1["risk"]) == str(alert2[3]) and str(alert1["certainty"]) == str(alert2[4]) and str(alert1["start"]) == str(alert2[5]) and str(alert1["end"]) == str(alert2[6])):
        return True
    else:
        return False
